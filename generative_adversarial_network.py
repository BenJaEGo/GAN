...
class GenerativeAdversarialNetwork(object):
    def __init__(self, n_input, n_generator_units, n_discriminator_units, n_latent, dis_lr, gen_lr, lam):
        ...
        self._generator = Generator(n_latent, n_generator_units, n_input, tf.nn.tanh, tf.nn.sigmoid)
