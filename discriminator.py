...
class Discriminator(object):
    def __init__(self, n_input, n_units, n_output, hidden_activation, output_activation):
        ...
        for layer_idx in range(self._n_layer):
            layer_name = "discriminator_hidden_layer_" + str(layer_idx + 1)
            if layer_idx is 0:
        ...
        layer_name = "discriminator_output_layer"
